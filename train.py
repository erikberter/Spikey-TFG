...
from network import C3D_model, R2Plus1D_model, R3D_model, C3D_model_lite
...
modelName = 'C3D_lite' # Options: C3D or R2Plus1D or R3D
...
def train_model(dataset=dataset, save_dir=save_dir, num_classes=num_classes, lr=lr,
    ...
    elif modelName == 'C3D_lite':
        model = C3D_model_lite.C3D_lite(num_classes=num_classes, pretrained=False)
        train_params = [{'params': C3D_model.get_1x_lr_params(model), 'lr': lr},
                        {'params': C3D_model.get_10x_lr_params(model), 'lr': lr * 10}]
